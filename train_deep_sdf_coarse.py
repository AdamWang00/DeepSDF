...
def clip_logs(loss_log, sdf_loss_log, color_loss_log, lr_log, timing_log, lat_mag_log, param_mag_log, epoch):
    ...
    return (loss_log, sdf_loss_log, color_loss_log, lr_log, timing_log, lat_mag_log, param_mag_log)
...
def main_function(experiment_directory, continue_from):
    ...
    if continue_from is not None:
        ...
        loss_log, sdf_loss_log, color_loss_log, lr_log, timing_log, lat_mag_log, param_mag_log, log_epoch = load_logs(
            experiment_directory
        )

        if not log_epoch == model_epoch:
            loss_log, sdf_loss_log, color_loss_log, lr_log, timing_log, lat_mag_log, param_mag_log = clip_logs(
                loss_log, sdf_loss_log, color_loss_log, lr_log, timing_log, lat_mag_log, param_mag_log, model_epoch
            )
    ...
    for epoch in range(start_epoch, num_epochs + 1):
        ...
        for sdf_data, indices in sdf_loader: # sdf_data.shape is [ScenesPerBatch, SamplesPerScene, 7]
            ...
            sdf_data = sdf_data.reshape(-1, sdf_data.shape[2]) # x, y, z, sdf_gt, r, g, b
