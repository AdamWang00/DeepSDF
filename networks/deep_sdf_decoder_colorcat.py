...
class Decoder(nn.Module):
    def __init__(
        ...
        self.latent_size_partial = latent_size
        ...
        dims = [self.latent_size_partial + xyz_size] + dims + [1 + 512]
    ...
    def forward(self, input, scene_latent=None):
        ...
        latent_vecs = latent_vecs_global
    ...
    def forward_alt(self, xyz, latent_vec):
        ...
        latent_vec = latent_vec_global.repeat(xyz.shape[0], 1)
