...
python train_deep_sdf_colorcat_coarse.py -e experiments/nightstand3MbSG
python generate_training_meshes_color.py --cat -n -m 32 -c 1000 -e experiments/nightstand3MbSG
python evaluate_color.py -d ./data -n -m 32 -c 1000 -e experiments/nightstand3MbSG --name_surface 3D-FUTURE-model